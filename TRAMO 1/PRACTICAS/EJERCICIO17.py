#¡Ayuda! Se me rompió el programa que convierte una cantidad de dinero en 
# la cantidad mínima de billetes y monedas necesarios. 
...
def dinero():
    ...
    print("Para la cantidad de  ",cantidad_total,"se necesitan:",billetes_mil,"billetes de 1000")
    print(billetes_doscientos, "billetes de  200",billetes_cien,"billetes de 100")
    print(billetes_cincuenta, "billetes de  50",billetes_diez,"billetes de 10")
    print(billetes_cinco, "billetes de  5",billetes_uno,"billetes de 1")
